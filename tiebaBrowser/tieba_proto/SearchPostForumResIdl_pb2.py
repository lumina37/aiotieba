...
_SEARCHPOSTFORUMRESIDL = DESCRIPTOR.message_types_by_name['SearchPostForumResIdl']
_SEARCHPOSTFORUMRESIDL_DATARES = _SEARCHPOSTFORUMRESIDL.nested_types_by_name['DataRes']
_SEARCHPOSTFORUMRESIDL_DATARES_SEARCHFORUM = _SEARCHPOSTFORUMRESIDL_DATARES.nested_types_by_name['SearchForum']
SearchPostForumResIdl = _reflection.GeneratedProtocolMessageType('SearchPostForumResIdl', (_message.Message,), {

  'DataRes' : _reflection.GeneratedProtocolMessageType('DataRes', (_message.Message,), {

    'SearchForum' : _reflection.GeneratedProtocolMessageType('SearchForum', (_message.Message,), {
      'DESCRIPTOR' : _SEARCHPOSTFORUMRESIDL_DATARES_SEARCHFORUM,
      '__module__' : 'SearchPostForumResIdl_pb2'
      # @@protoc_insertion_point(class_scope:SearchPostForumResIdl.DataRes.SearchForum)
      })
    ,
    'DESCRIPTOR' : _SEARCHPOSTFORUMRESIDL_DATARES,
    '__module__' : 'SearchPostForumResIdl_pb2'
    # @@protoc_insertion_point(class_scope:SearchPostForumResIdl.DataRes)
    })
  ,
  'DESCRIPTOR' : _SEARCHPOSTFORUMRESIDL,
  '__module__' : 'SearchPostForumResIdl_pb2'
  # @@protoc_insertion_point(class_scope:SearchPostForumResIdl)
  })
_sym_db.RegisterMessage(SearchPostForumResIdl)
_sym_db.RegisterMessage(SearchPostForumResIdl.DataRes)
_sym_db.RegisterMessage(SearchPostForumResIdl.DataRes.SearchForum)
