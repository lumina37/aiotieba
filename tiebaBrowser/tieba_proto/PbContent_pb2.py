...
_PBCONTENT_ITEM = _PBCONTENT.nested_types_by_name['Item']
PbContent = _reflection.GeneratedProtocolMessageType('PbContent', (_message.Message,), {
  ...
  'Item' : _reflection.GeneratedProtocolMessageType('Item', (_message.Message,), {
    'DESCRIPTOR' : _PBCONTENT_ITEM,
    '__module__' : 'PbContent_pb2'
    # @@protoc_insertion_point(class_scope:PbContent.Item)
    })
  ,
...
_sym_db.RegisterMessage(PbContent.Item)
