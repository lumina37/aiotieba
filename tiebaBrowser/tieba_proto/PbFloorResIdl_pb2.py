...
_PBFLOORRESIDL = DESCRIPTOR.message_types_by_name['PbFloorResIdl']
_PBFLOORRESIDL_DATARES = _PBFLOORRESIDL.nested_types_by_name['DataRes']
PbFloorResIdl = _reflection.GeneratedProtocolMessageType('PbFloorResIdl', (_message.Message,), {

  'DataRes' : _reflection.GeneratedProtocolMessageType('DataRes', (_message.Message,), {
    'DESCRIPTOR' : _PBFLOORRESIDL_DATARES,
    '__module__' : 'PbFloorResIdl_pb2'
...
_sym_db.RegisterMessage(PbFloorResIdl.DataRes)
