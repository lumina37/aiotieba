...
class RegularExp(object):
    ...
    maipian_exp = re.compile(
        '(下|↓).{0,3}有惊喜|浮力车|网红.{0,3}作品|成人看的|小情侣|注意身体|推荐.{0,3}资源|回复.*:你(帖|贴).*可以看|自己上微.?薄|自己.*捜|都有.*看我关注的人|experience\+.{0,8}#.*#|范 做|看偏神器|学姐给我吃|推荐发展对象|脱单|^麦片$|卖淫|嫂子直接.*那个|小哥哥们.*看我|进去.*弄得喷水|(看|有)女神|噜.?个月|鲁管|肾不好|[\u0101-\u017e]|箹|\{.?\}|〖.〗|诚人|1928.ME|湖北厕所')
