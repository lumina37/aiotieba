...
class RegularExp(object):
    ...
    app_nocheck_exp = re.compile(
        'tao寳|tb口令|(淘宝|抖音).{0,2}(号|hao)|绿色.{0,2}平台|赛事预测|【支付宝】|解封微信|扫码.{0,3}送红包|关注.{0,2}微博|帮注册|茨|视频助手|呅|開|嬴|最大1111|收soul.?天|↓住|5.{2}·|流亮|你的够用吗？|聊天.?有惊喜|y͏u͏n͏g͏e͏8͏8͏7͏|a͏i͏s͏h͏e͏n͏5͏7͏6͏|【娛】|缅甸.{0,3}娱乐|租房神器', re.I)
    app_exp = re.compile(
        '拼(夕夕|多多|dd)|京(东|d)|抖音|支付宝|淘.?宝|火山小视频|微信|饿.?了.?么|美.?团|唯品会|苏宁|易购|app.{0,4}下载|双(11|十一)|语音平台|起点读书', re.I)
    ...
    job_check_exp = re.compile(
        '(暑假|临时|短期)工|合伙|兼职|主播|声播|签约|艺人|模特|陪玩|写手|点赞员|接单|工作室|工厂|手工|项目|电商|创业|自媒体|加盟|副业|代理|(免费|需要|诚信|诚心)(带|做)|想(赚|挣)钱|不甘.?现状|微商|投资|写好评|不嫌少|需工作|形象好|气质佳|赢.{0,2}奖金')
