...
class RegularExp(object):
    ...
    contact_rare_exp = re.compile(
        '(在|看|→|👉|☞放).{0,3}(我|俺|偶).{0,3}((贴|帖)(子|里)|关注|主页|主业|资料|签名|尾巴|简介|(头|投)(像|象))|(头|投).(像|象)|主.页|(关注|主页|主业|资料|签名|尾巴|简介|(头|投)(像|象))(有|安排|上车)|威(信|辛)|v信|(\+|加|联系|了解|十|＋|私|找|伽).{0,2}(威|薇|徽|微|wx|v|q|企鹅|❤|蔻|寇|偶)|(十|＋|伽).{0,2}(我|俺|偶)|(威|薇|威|微|wx|v|企鹅|❤|蔻|寇).{0,2}(:|：|号)|q.?\d{6,11}|有意.{0,3}(s|私)|连细方式|罔址|芷|个.?性.?签.?名|簽|萜|貼|∨|Ⓥ|✙|➕|徾', re.I)
    ...
    app_nocheck_exp = re.compile(
        'tao寳|tb口令|(淘宝|抖音).{0,2}(号|hao)|绿色.{0,2}平台|赛事预测|【支付宝】|解封微信|扫码.{0,3}送红包|关注.{0,2}微博|帮注册|茨|视频助手|呅|開|嬴|最大1111|收soul.?天|↓住|5.{2}·|流亮|你的够用吗？|聊天.?有惊喜|y͏u͏n͏g͏e͏8͏8͏7͏|a͏i͏s͏h͏e͏n͏5͏7͏6͏|【娛】|缅甸.{0,3}娱乐', re.I)
    app_exp = re.compile(
