...
async def request(http_core: HttpCore, fid: int, tid: int, is_hide: bool) -> TbResponse:
    data = [
    ...
    request = http_core.pack_form_request(
        yarl.URL.build(scheme=APP_SECURE_SCHEME, host=APP_BASE_HOST, path="/c/c/bawu/delthread"), data
    )
