...
if _descriptor._USE_C_DESCRIPTORS is False:
    ...
    _globals['_POSTINFOLIST']._serialized_end = 750
    _globals['_POSTINFOLIST_POSTINFOCONTENT']._serialized_start = 642
    _globals['_POSTINFOLIST_POSTINFOCONTENT']._serialized_end = 750
