...
if _descriptor._USE_C_DESCRIPTORS is False:
    ...
    _globals['_POST']._serialized_start = 95
    _globals['_POST']._serialized_end = 712
    _globals['_POST_SUBPOST']._serialized_start = 472
    _globals['_POST_SUBPOST']._serialized_end = 518
    _globals['_POST_SIGNATUREDATA']._serialized_start = 520
    _globals['_POST_SIGNATUREDATA']._serialized_end = 638
    _globals['_POST_SIGNATUREDATA_SIGNATURECONTENT']._serialized_start = 592
    _globals['_POST_SIGNATUREDATA_SIGNATURECONTENT']._serialized_end = 638
    _globals['_POST_CUSTOMFIGURE']._serialized_start = 640
    _globals['_POST_CUSTOMFIGURE']._serialized_end = 680
    _globals['_POST_CUSTOMSTATE']._serialized_start = 682
    _globals['_POST_CUSTOMSTATE']._serialized_end = 712
