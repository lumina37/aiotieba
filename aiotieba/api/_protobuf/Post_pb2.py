...
if _descriptor._USE_C_DESCRIPTORS is False:
    ...
    _globals['_POST']._serialized_end = 742
    _globals['_POST_SUBPOST']._serialized_start = 467
    _globals['_POST_SUBPOST']._serialized_end = 513
    _globals['_POST_SIGNATUREDATA']._serialized_start = 515
    _globals['_POST_SIGNATUREDATA']._serialized_end = 633
    _globals['_POST_SIGNATUREDATA_SIGNATURECONTENT']._serialized_start = 587
    _globals['_POST_SIGNATUREDATA_SIGNATURECONTENT']._serialized_end = 633
    _globals['_POST_CUSTOMFIGURE']._serialized_start = 635
    _globals['_POST_CUSTOMFIGURE']._serialized_end = 675
    _globals['_POST_CUSTOMSTATE']._serialized_start = 677
    _globals['_POST_CUSTOMSTATE']._serialized_end = 707
    _globals['_POST_SPRITEMEMEINFO']._serialized_start = 709
    _globals['_POST_SPRITEMEMEINFO']._serialized_end = 742
