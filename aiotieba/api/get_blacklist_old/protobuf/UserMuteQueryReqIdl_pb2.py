...
if _descriptor._USE_C_DESCRIPTORS is False:
    ...
    _globals['_USERMUTEQUERYREQIDL']._serialized_end = 211
    _globals['_USERMUTEQUERYREQIDL_DATAREQ']._serialized_start = 114
    _globals['_USERMUTEQUERYREQIDL_DATAREQ']._serialized_end = 211
