...
class Contents_t(Containers[TypeFragment]):
    ...
    Attributes:
        ...
        videos (list[FragVideo_t]): 视频碎片列表
    ...
    @property
    def videos(self) -> List[FragVideo_t]:
        """
        视频碎片列表
        """
...
class Contents_st(Containers[TypeFragment]):
    ...
    Attributes:
        ...
        videos (list[FragVideo_st]): 视频碎片列表
    ...
    @property
    def videos(self) -> List[FragVideo_st]:
        """
        视频碎片列表
        """
