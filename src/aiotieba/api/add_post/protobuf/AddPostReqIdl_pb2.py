...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_DATAREQ"]._serialized_start = 41
    _globals["_DATAREQ"]._serialized_end = 499
    _globals["_ADDPOSTREQIDL"]._serialized_start = 501
    _globals["_ADDPOSTREQIDL"]._serialized_end = 540
