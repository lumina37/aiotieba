...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_THREADINFO"]._serialized_end = 1047
    _globals["_THREADINFO_ORIGINTHREADINFO"]._serialized_start = 818
    _globals["_THREADINFO_ORIGINTHREADINFO"]._serialized_end = 1047
