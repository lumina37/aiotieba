...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_USERMUTEQUERYREQIDL"]._serialized_start = 109
    _globals["_USERMUTEQUERYREQIDL"]._serialized_end = 154
