...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_DATAREQ"]._serialized_start = 40
    _globals["_DATAREQ"]._serialized_end = 128
    _globals["_PBFLOORREQIDL"]._serialized_start = 130
    _globals["_PBFLOORREQIDL"]._serialized_end = 169
