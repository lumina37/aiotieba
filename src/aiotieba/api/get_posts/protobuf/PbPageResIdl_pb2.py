...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_DATARES"]._serialized_start = 109
    _globals["_DATARES"]._serialized_end = 274
    _globals["_PBPAGERESIDL"]._serialized_start = 276
    _globals["_PBPAGERESIDL"]._serialized_end = 337
