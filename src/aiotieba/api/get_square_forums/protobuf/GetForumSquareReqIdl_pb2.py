...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_GETFORUMSQUAREREQIDL"]._serialized_start = 147
    _globals["_GETFORUMSQUAREREQIDL"]._serialized_end = 193
