...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_DATAREQ"]._serialized_end = 89
    _globals["_REPLYMEREQIDL"]._serialized_start = 91
    _globals["_REPLYMEREQIDL"]._serialized_end = 130
