...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_DATAREQ"]._serialized_end = 180
    _globals["_FRSPAGEREQIDL"]._serialized_start = 182
    _globals["_FRSPAGEREQIDL"]._serialized_end = 221
