...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_DATAREQ"]._serialized_end = 171
    _globals["_PROFILEREQIDL"]._serialized_start = 173
    _globals["_PROFILEREQIDL"]._serialized_end = 212
