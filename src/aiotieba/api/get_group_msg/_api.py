...
def pack_proto(account: Account, group_ids: Iterable[int], msg_ids: Iterable[int], get_type: int) -> bytes:
...
async def request(ws_core: WsCore, group_ids: Iterable[int], get_type: int) -> WsMsgGroups:
